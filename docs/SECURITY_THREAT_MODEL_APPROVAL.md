...
- Version control is not initialized in this working copy, so `SEC-SUPPLY-002` and `SEC-SUPPLY-003` cannot be exercised and CI has never executed. Since amendment A-1 this is recorded as `AR-001` in `docs/SECURITY_ACCEPTED_RISKS.md`.
